module TopCPU (clk,
 ...
 sky130_fd_sc_hd__o211a_1 _2471_ (.A1(\cpu_inst.rf.registers[2][10] ),
    ...
    .VPWR(VPWR),
    .X(_0719_));
 sky130_fd_sc_hd__a211o_1 _2472_ (.A1(net190),
    .A2(_0717_),
    .B1(_0719_),
    .C1(_0622_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o211a_2 _2542_ (.A1(\cpu_inst.rf.registers[2][9] ),
    ...
    .VPWR(VPWR),
    .X(_0790_));
 sky130_fd_sc_hd__a211o_2 _2543_ (.A1(net190),
    .A2(_0788_),
    .B1(_0790_),
    .C1(_0622_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o211a_4 _3025_ (.A1(\cpu_inst.rf.registers[2][7] ),
    ...
    .VPWR(VPWR),
    .X(_1273_));
 sky130_fd_sc_hd__a211o_1 _3026_ (.A1(net190),
    .A2(_1271_),
    .B1(_1273_),
    .C1(_0663_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o211a_2 _3048_ (.A1(\cpu_inst.rf.registers[2][8] ),
    ...
    .VPWR(VPWR),
    .X(_1296_));
 sky130_fd_sc_hd__a211o_2 _3049_ (.A1(net190),
    .A2(_1294_),
    .B1(_1296_),
    .C1(_0663_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _3333_ (.A(_0944_),
    ...
    .VPWR(VPWR),
    .Y(_1570_));
 sky130_fd_sc_hd__nor4_1 _3334_ (.A(_1569_),
    .B(_1570_),
    .C(net34),
    .D(net33),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__buf_12 fanout3 (.A(_0545_),
    ...
    .VPWR(VPWR),
    .X(net190));
 sky130_fd_sc_hd__buf_1 fanout4 (.A(_0458_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
